...
:host([scale=m]) {
  ...
  --calcite-chip-spacing-unit-s: calc(0.75rem / 2);
}
...
:host([scale=s]:not([closable])) .container:not(.content--slotted) .image-container {
...
:host([scale=m]:not([closable])) .container:not(.content--slotted) .image-container {
...
:host([scale=l]:not([closable])) .container:not(.content--slotted) .image-container {
...
:host([appearance=outline]) .close-icon {
  color: var(--calcite-ui-text-3);
}
