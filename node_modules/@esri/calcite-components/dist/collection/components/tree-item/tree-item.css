...
:host([scale=s]) .node-actions-container .node-container {
...
:host([scale=s]) .node-actions-container .actions-end {
  display: inline-flex;
}
...
:host([scale=m]) .node-actions-container .node-container {
...
:host([scale=m]) .node-actions-container .actions-end {
  display: inline-flex;
}
...
:host([scale=l]) .node-actions-container .node-container {
...
:host([scale=l]) .node-actions-container .actions-end {
  display: inline-flex;
}
