...
const resources = require('./resources-4c8610b1.js');
const label = require('./label-28060b83.js');
const form = require('./form-1d831023.js');
const floatingUi = require('./floating-ui-b48c8256.js');
const interactive = require('./interactive-32293bca.js');
const dom = require('./dom-2ec8c9ed.js');
const openCloseComponent = require('./openCloseComponent-178191c0.js');
const locale = require('./locale-678ce361.js');
const key = require('./key-6a462411.js');
require('./debounce-2c8b61fb.js');
require('./resources-b5a5f8a7.js');
require('./guid-f4f03a7a.js');
require('./observers-5706326b.js');
    ...
    if (focusedInput === "start") {
      ...
      if (!this.endAsDate || !resources.sameDate(date, this.endAsDate)) {
        ...
        this.calciteDatePickerRangeChange.emit({
          ...
          endDate: resources.setEndOfDay(date)
        });
      }
    }
  }
