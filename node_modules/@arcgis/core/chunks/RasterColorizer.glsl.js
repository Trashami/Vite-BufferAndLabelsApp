...
gl_FragColor = applyBackgroundBlend(vec4(hillshade, hillshade, hillshade, alpha));`;o.code.add(g`
  ...
  `)}const z=Object.freeze(Object.defineProperty({__proto__:null,ColorizerUniforms:v,ColorizerStretchUniforms:_,ColorizerHillshadeUniforms:y,build:h},Symbol.toStringTag,{value:"Module"}));export{v as C,z as R,_ as a,y as b,h as c};
