    ...
    if ("string" != typeof r2 && !Array.isArray(r2)) {
      for (const i2 in r2)
        if ("default" !== i2 && !(i2 in e)) {
          const a3 = Object.getOwnPropertyDescriptor(r2, i2);
          a3 && Object.defineProperty(e, i2, a3.get ? a3 : { enumerable: true, get: () => r2[i2] });
        }
    }
  }
...
var t;
var s = { exports: {} };
r = s, o2 = s.exports, n2 = function(e, i) {
...
}, void 0 !== (t = n2(n, o2)) && (r.exports = t);
var d = a({ __proto__: null, default: o(s.exports) }, [s.exports]);
export {
  d as s
};
//# sourceMappingURL=sl_SL-EBOXH2I3.js.map
