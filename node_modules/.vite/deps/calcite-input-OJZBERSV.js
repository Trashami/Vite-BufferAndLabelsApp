import {
  ...
  disconnectForm,
  submitForm
} from "./chunk-44SVYCG7.js";
import {
  connectLabel,
  disconnectLabel,
  getLabelText
} from "./chunk-7TV3YJNJ.js";
import {
  numberKeys
} from "./chunk-ZHU6EFH7.js";
import {
...
var Input = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    const inputClearButton = h("button", { "aria-label": this.intlClear || TEXT2.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { icon: "x", scale: "s" }));
...
// node_modules/@arcgis/core/node_modules/@esri/calcite-components/dist/components/calcite-input.js
var CalciteInput = Input;
 ...
 * v1.0.0-beta.97
 */
//# sourceMappingURL=calcite-input-OJZBERSV.js.map
