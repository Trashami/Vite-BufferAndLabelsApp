...
var m2 = ["bottom", "bottom-start", "bottom-end", "left", "left-start", "left-end", "right", "right-start", "right-end", "top", "top-start", "top-end"];
var u = { base: "esri-popover", open: "esri-popover--open" };
var _ = { position: "fixed", "z-index": "1000" };
var f = class extends M {
  constructor(t2, e3) {
    super(t2, e3), this._popper = null, this._contentNode = null, this._renderAttached = false, this._rootNode = null, this.anchorElement = null, this.offset = [0, 0], this.open = false, this.renderContentFunction = null, this._afterRootCreate = (t3) => {
      this._rootNode = t3;
    }, this._afterContentCreate = (t3) => {
      this._contentNode = t3;
    }, this._updatePosition = () => {
      r(this._popper) && this._popper.update();
    };
  }
  initialize() {
    this.when(() => {
  ...
  destroy() {
    this.owner = null, this.anchorElement = null, this.renderContentFunction = null, this._renderAttached && (this._projector.detach(this.render), this._renderAttached = false), r(this._rootNode) && (l2(this._rootNode), this._rootNode = null), this._contentNode = null, r(this._popper) && (this._popper.destroy(), this._popper = null);
  }
  set container(t2) {
  }
  set owner(t2) {
  ...
  set placement(t2) {
    m2.includes(t2) ? this._override("placement", t2) : this._clearOverride("placement");
  }
  render() {
    var _a;
    const { open: t2, owner: e3, renderContentFunction: o } = this;
    return n2("div", { afterCreate: this._afterRootCreate, class: this.classes(u.base, t2 ? u.open : null), styles: _ }, n2("div", { dir: m((_a = this.owner) == null ? void 0 : _a.container), afterCreate: this._afterContentCreate, afterUpdate: this._updatePosition }, t2 && (o == null ? void 0 : o.call(e3))));
  }
  _buildPopper() {
    r(this._popper) && (this._popper.destroy(), this._popper = null);
    const t2 = this._contentNode;
    if (t(t2))
      return;
    if (!this.open || !this.renderContentFunction)
      return;
    const o = this._getAnchor();
    o && (this._popper = createPopper3(o, t2), this._setPopperOptions());
  }
  _setPopperOptions() {
    const { placement: t2, offset: e3, _popper: o } = this;
    t(o) || (o.setOptions({ placement: t2, modifiers: [{ name: "offset", options: { offset: e3 } }] }), o.forceUpdate());
  }
  _getAnchor() {
    const { anchorElement: t2 } = this;
    return e2("function" == typeof t2 ? t2() : t2);
  }
};
e([y()], f.prototype, "anchorElement", void 0), e([y()], f.prototype, "container", null), e([y()], f.prototype, "offset", void 0), e([y()], f.prototype, "open", void 0), e([y()], f.prototype, "owner", null), e([y()], f.prototype, "placement", null), e([y()], f.prototype, "renderContentFunction", void 0), f = e([n("esri.widgets.support.Popover")], f);
var y2 = f;

export {
  y2 as y
};
//# sourceMappingURL=chunk-627QBPPF.js.map
