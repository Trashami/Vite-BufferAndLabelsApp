    ...
    if ("string" != typeof t2 && !Array.isArray(t2)) {
      for (const r2 in t2)
        if ("default" !== r2 && !(r2 in e)) {
          const n4 = Object.getOwnPropertyDescriptor(t2, r2);
          n4 && Object.defineProperty(e, r2, n4.get ? n4 : { enumerable: true, get: () => t2[r2] });
        }
    }
  }
...
var o2;
var s = { exports: {} };
t = s, a = s.exports, i = function(e, r) {
...
}, void 0 !== (o2 = i(n, a)) && (t.exports = o2);
var u = n2({ __proto__: null, default: o(s.exports) }, [s.exports]);
export {
  u as d
};
//# sourceMappingURL=de_CH-3RK4WP6Y.js.map
