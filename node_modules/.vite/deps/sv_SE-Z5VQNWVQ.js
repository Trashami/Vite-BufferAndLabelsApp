...
function a(e, r) {
  for (var a2 = 0; a2 < r.length; a2++) {
    ...
    if ("string" != typeof t2 && !Array.isArray(t2)) {
      for (const r2 in t2)
        if ("default" !== r2 && !(r2 in e)) {
          const a3 = Object.getOwnPropertyDescriptor(t2, r2);
          a3 && Object.defineProperty(e, r2, a3.get ? a3 : { enumerable: true, get: () => t2[r2] });
        }
    }
  }
...
}, void 0 !== (i = n2(n, o2)) && (t.exports = i);
var l = a({ __proto__: null, default: o(s.exports) }, [s.exports]);
export {
  l as s
};
//# sourceMappingURL=sv_SE-Z5VQNWVQ.js.map
