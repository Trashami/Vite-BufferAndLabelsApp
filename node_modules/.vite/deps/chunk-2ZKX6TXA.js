...
async function T(n, e, a2 = true) {
  ...
  return { ...i2, coordinate: w.fromJSON(i2.coordinate) };
}
async function V(n, e) {
  const a2 = await s("nearestVertex", [r(n), n, e]);
  return { ...a2, coordinate: w.fromJSON(a2.coordinate) };
}
async function z(n, e, a2, i2) {
  return (await s("nearestVertices", [r(n), n, e, a2, i2])).map((n2) => ({ ...n2, coordinate: w.fromJSON(n2.coordinate) }));
}
function G(n) {
  var _a;
...
//# sourceMappingURL=chunk-2ZKX6TXA.js.map
